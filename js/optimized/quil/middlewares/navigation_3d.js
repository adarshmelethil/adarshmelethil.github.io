...
var vec__6576 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6576,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6576,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6576,(2),null);
var vec__6579 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6579,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6579,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6579,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__6582,p__6583){
var vec__6584 = p__6582;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6584,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6584,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6584,(2),null);
var vec__6587 = p__6583;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6587,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6587,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6587,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__6590_SHARP_){
return (p1__6590_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__6591_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__6592_SHARP_,angle_lr),angle_ud);
...
var map__6594 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__6594__$1 = (((((!((map__6594 == null))))?(((((map__6594.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6594.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6594):map__6594);
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6594__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6594__$1,cljs.core.cst$kw$straight);
var temp__5733__auto__ = (function (){var pred__6596 = cljs.core._EQ_;
var expr__6597 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__6599 = cljs.core.cst$kw$w;
var G__6600 = expr__6597;
return (pred__6596.cljs$core$IFn$_invoke$arity$2 ? pred__6596.cljs$core$IFn$_invoke$arity$2(G__6599,G__6600) : pred__6596.call(null,G__6599,G__6600));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__6601 = cljs.core.cst$kw$s;
var G__6602 = expr__6597;
return (pred__6596.cljs$core$IFn$_invoke$arity$2 ? pred__6596.cljs$core$IFn$_invoke$arity$2(G__6601,G__6602) : pred__6596.call(null,G__6601,G__6602));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__6596.cljs$core$IFn$_invoke$arity$2 ? pred__6596.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__6597) : pred__6596.call(null,quil.middlewares.navigation_3d.space,expr__6597)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__6603 = cljs.core.cst$kw$z;
var G__6604 = expr__6597;
return (pred__6596.cljs$core$IFn$_invoke$arity$2 ? pred__6596.cljs$core$IFn$_invoke$arity$2(G__6603,G__6604) : pred__6596.call(null,G__6603,G__6604));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__6605 = cljs.core.cst$kw$d;
var G__6606 = expr__6597;
return (pred__6596.cljs$core$IFn$_invoke$arity$2 ? pred__6596.cljs$core$IFn$_invoke$arity$2(G__6605,G__6606) : pred__6596.call(null,G__6605,G__6606));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__6607 = cljs.core.cst$kw$a;
var G__6608 = expr__6597;
return (pred__6596.cljs$core$IFn$_invoke$arity$2 ? pred__6596.cljs$core$IFn$_invoke$arity$2(G__6607,G__6608) : pred__6596.call(null,G__6607,G__6608));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__5733__auto__,map__6594,map__6594__$1,up,straight){
return (function (p1__6593_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__6593_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__5733__auto__,map__6594,map__6594__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__6609_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6609_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__6610 = options;
var G__6611 = ((function (G__6610,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__6610,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__6610,G__6611) : rotate_on.call(null,G__6610,G__6611));
})();
...
var map__6612_6627 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__6612_6628__$1 = (((((!((map__6612_6627 == null))))?(((((map__6612_6627.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6612_6627.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6612_6627):map__6612_6627);
var vec__6613_6629 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6612_6628__$1,cljs.core.cst$kw$straight);
var c_x_6630 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6613_6629,(0),null);
var c_y_6631 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6613_6629,(1),null);
var c_z_6632 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6613_6629,(2),null);
var vec__6616_6633 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6612_6628__$1,cljs.core.cst$kw$up);
var u_x_6634 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6616_6633,(0),null);
var u_y_6635 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6616_6633,(1),null);
var u_z_6636 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6616_6633,(2),null);
var vec__6619_6637 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6612_6628__$1,cljs.core.cst$kw$position);
var p_x_6638 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6619_6637,(0),null);
var p_y_6639 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6619_6637,(1),null);
var p_z_6640 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6619_6637,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_6638,p_y_6639,p_z_6640,(p_x_6638 + c_x_6630),(p_y_6639 + c_y_6631),(p_z_6640 + c_z_6632),u_x_6634,u_y_6635,u_z_6636);
...
var G__6623 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__6624 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__6623,G__6624) : key_pressed.call(null,G__6623,G__6624));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__6625 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__6626 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__6625,G__6626) : rotate_on_fn.call(null,G__6625,G__6626));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
